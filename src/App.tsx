      ...
      {view === "home" && (
        <main style={{ maxWidth: 960, margin: "0 auto", padding: "24px 20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 20 }}>
            <div style={{ fontSize: 34, fontWeight: 700, letterSpacing: "-0.5px" }}>Collection</div>
            <button onClick={() => setCreatingProject(true)} style={{ background: "none", border: "1px solid #007AFF", color: "#007AFF", padding: "7px 14px", borderRadius: 20, fontSize: 13, fontWeight: 500, cursor: "pointer", fontFamily: "inherit" }}>共有プロジェクト</button>
          </div>
